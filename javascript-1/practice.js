...
// Create a function called 'sum' that takes in two parameters, 'num1' and 'num2'. The function should return the sum of the two 
// parameters.
...
// The value of the firstName key should be your name as a string. The value of the property state should be your current state or 
// providence of residence as a string. The value of age should be your age as a number. greeter should be a method that returns 
// the string 'Hello! My name is NAMEVALUE and I live in STATEVALUE' with the corresponding values. 
...
// // // Create a function called 'arrayReverser' that takes in one parameter, 'arr'. Inside of arrayReverser, create an empty array 
// called 'reversed'. Using a for loop, loop over the passed in array IN REVERSE (this means your counter should decrement), and then add 
// each item to the 'reversed' array variable you created. Finally, return the 'reversed' array variable. 
...
// // // Below is an array, myNumbers. You will be using .map, .filter, .reduce and .forEach to manipulate the array in the following 
// problems.
...
const doubled = myNumbers.map(n => n * 2)
...
// // Code Here
const total = myNumbers.reduce ((n1, n2) => n1 + n2 );
// let total = myNumbers.reduce((acc, element, index, array) => {
// 	if (i=0 
// })
// //////////////////PROBLEM 17////////////////////
...
// to George using .map. Store the resulting array in a variable named 'forTheLoveOfGeorge'.
...
// })
// let enemies = person => person.friend

// let enemies = people.filter(friend => friend= false)
// //////////////////PROBLEM 20////////////////////
...
// // Code Here
// let totallyAwesome =people.reduce(people.awesomeLevel) 
// people.awesomeLevel(i){
// 	awesomeLevel.reduce
// }
// let totallyAwesome = people.reduce(awesomeLevel => n1 +n2)